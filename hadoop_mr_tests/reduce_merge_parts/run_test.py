...
"""
Test to determine how reduce tasks merge map output files.
This test is arranged such that there will be n mappers each
generating single output files of size k where n and k are
values that we choose. Additionally, only a single reducer
is run.
"""
